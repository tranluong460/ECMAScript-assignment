...
const Register = function () {
    ...
    <div class="lg:flex">
        <div class="hidden lg:flex items-center justify-center bg-indigo-100 flex-1 h-screen">
            <a href="/" class="max-w-xs transform duration-200 hover:scale-110 cursor-pointer">
            ...
            <div class="mt-5 px-7 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                ...
                <div class="mt-4">
                        <div>
                            ...
                            <input id="username" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="luong@gmail.com">
                        </div>

                        <div class="mt-4">
                            <div class="text-sm font-bold text-gray-700 tracking-wide">Email</div>
                            <input id="email" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="Trần Văn Lương">
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <input id="password" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="Mời nhập mật khẩu">
                        </div>

                        <div class="mt-4">
                            <div class="text-sm font-bold text-gray-700 tracking-wide">Số điện thoại</div>
                            <input id="phone" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="0123456789">
                        </div>

                        <div class="mt-4">
                            <div class="text-sm font-bold text-gray-700 tracking-wide">Địa chỉ</div>
                            <input id="address" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="Bắc Giang">
                        </div>
